Otra desarrolladora, Lorena, acaba de agregar una feature mientras nosotros corregíamos el bug en `votar!`.
...
> ¿Y qué pasaría si probamos los dos? Probá el `votar!(tema, asambleista)` y el `desvotar!(tema, asambleista)` en `Asamblea`. 
